...
with top_middle:
    try:
        ...
        knowledge_graph_image = Image.open("../data/knowledge_graph.png")
        st.image(knowledge_graph_image, caption="knowledge graph (향후 PostgreSQL 연동 예정)", width=int(knowledge_graph_image.width * 0.7))
    except FileNotFoundError:
        st.info("이미지를 찾을 수 없습니다. (data/knowledge_graph.png)")
